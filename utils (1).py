...
def get_response_llm(llm, vector_store, query):
    ...
    prompt_template = """
    Human: Answer the question from the provided context. Don't use your pretrained knowledge, just use the context provided. 
        Don't exceed 150 words on the explanation. If you don't know the answer, just say that you don't know, 
